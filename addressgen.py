def addrGenerator():
  ...
  streetnames = ["Main Street", "Church Street", "Main Street North", "Main Street South", "Elm Street", "High Street", "Main Street West", "Washington Street", "Forster Close", "Alfred Street", "Allington Street", "Alma Road", "Somertrees Avenue", "Batson Street", "Bentinck Street", "George Street"]
